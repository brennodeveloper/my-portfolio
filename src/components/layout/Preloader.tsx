      ...
      >
        <div className="mb-8">
          <svg xmlns="http://www.w3.org/2000/svg" width="200" height="190" viewBox="0 0 102 98" fill="none" aria-label="Logo Brenno Souza">
            <path stroke="#8aebff" strokeWidth="5" d="M2.5 50.897C2.5 110 99 109.5 99 50.897M2.5 50.897c0-17.394 7.003-30.111 17.236-38.119"/>
            <path stroke="#8aebff" strokeWidth="5" d="M44.88 2.874C70.582.187 98.544 16.245 99.02 51.302"/>
            <circle cx="25.008" cy="8.517" r="3.244" fill="#8aebff" />
            <circle cx="37.174" cy="3.244" r="3.244" fill="#8aebff" />
            <path fill="#8aebff" d="M44.07 53.533v13.18h12.369c9.733 0 9.936-13.18 0-13.18zM44.07 40.352v-9.125h12.369c6.083 0 6.175 8.798 0 9.125-6.176.328-12.37 0-12.37 0"/>
            <path stroke="#8aebff" strokeWidth="2.839" d="M56.439 31.227h-12.37v9.125s6.194.328 12.37 0c6.175-.327 6.083-9.125 0-9.125Zm-12.37 0h12.37m0 22.306h-12.37v13.18h12.37m-12.37-13.18h12.37m-12.37 13.18h12.37m0 0c9.733 0 9.936-13.18 0-13.18"/>
            <path fill="#8aebff" stroke="#8aebff" d="m46.5 78.5 18 14c25.416-10.743 32.659-21.807 33.5-50L67 28c4.431 6.211 5.104 10.034-2.5 18.5 8.14 3.251 17.083 19.171 0 30-6.46 3.486-10.639 2.809-18 2Z"/>
          </svg>
        </div>

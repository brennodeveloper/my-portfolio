export function HeroSection() {
  return (
    <section className="min-h-screen scroll-mt-24">
      <h2 className="text-4xl font-bold">Home</h2>
      <p>
        texto ilustrativo... Lorem Ipsum is not simply
        random text. It has roots in a piece of classical Latin literature from
        45 BC, making it over 2000 years old. Contrary to popular belief, Lorem 
